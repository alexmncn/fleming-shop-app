...
class FeaturedArticlesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            FeaturedScreen(featuredArticlesTotal, featuredArticles, featuredAListName, onShowMore = { loadFeaturedArticles() })
        }
...
@Composable
fun FeaturedScreen(featuredArticlesTotal: Int, featuredArticles: List<Article>, featuredListName: String, onShowMore: () -> Unit) {
    FlemingShopTheme {
        Scaffold(
            topBar = { MainTopBar() },
...
fun PreviewFeaturedScreen() {
    ...
    FeaturedScreen(sampleArticles.size+20, featuredArticles = sampleArticles, "Destacado", onShowMore = {})
}